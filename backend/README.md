...
## Project Structure
    ...
    ├── testapiautosetting_125518  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125518`
...
2. Clone this repo and `cd testapiautosetting_125518`
